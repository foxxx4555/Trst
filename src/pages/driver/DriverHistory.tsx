...
export default function DriverHistory() {
  ...
  const handleFinish = async (load: any) => {
    ...
    try {
      ...
      toast.success("تم تأكيد وصول الشحنة وإبلاغ التاجر ✅");
      fetchData();
          ...
          <div className="grid gap-5">
            {loads.length === 0 ? (
              <div className="py-20 text-center bg-white rounded-3xl border-2 border-dashed">
                ...
                <p className="text-slate-400 font-bold">لا توجد شحنات مرتبطة بحسابك</p>
              </div>
            ) : loads.map(load => (
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent className="rounded-[2.5rem] p-8 border-none shadow-2xl">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="font-bold py-4 text-slate-500 text-md">سيتم إرجاع هذه الشحنة للسوق ليراها السائقون الآخرون وتختفي من حسابك.</AlertDialogDescription>
                          </AlertDialogHeader>
